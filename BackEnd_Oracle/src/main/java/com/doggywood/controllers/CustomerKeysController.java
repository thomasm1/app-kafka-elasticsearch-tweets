...
import com.doggywood.entities.CustomerKeysBean;
...
@CrossOrigin(origins = "*")
@RestController
public class CustomerKeysController {
...
// CUSTOMER BEAN LANDING 
	...
	public CustomerKeysBean customerWelcomBean() {
		return new CustomerKeysBean("Welcome to Doggywood");
	}

//	 CUSTOMER BEAN LANDING - get info
//customer-welcome/value-variable/
	@GetMapping(value = "/customer-welcome/{email}")
	public CustomerKeysBean customerWelcomeBean(@PathVariable String email) {
		return new CustomerKeysBean(String.format("Welcome to Doggywood, %s!", email));
	}
