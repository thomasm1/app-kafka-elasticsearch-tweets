...
import xyz.cryptomaven.rest.services.UsersService;

import java.util.ArrayList;
import java.util.List;
import java.util.Optional;

import static xyz.cryptomaven.rest.util.constants.Constants.USER_PATH;
...
public class UsersController {
  ...
  public ResponseEntity<UserDto> patchUserById(@PathVariable("userId") Long userId,
