...
//		this.restTemplate = restTemplate;
    ...
    public ModelAndView processNewLoanApplication(LoanApplication loan)
    {
        ...
        URI location = restTemplate.postForLocation("http://loans.cryptomaven.xyz/loanApplication", loan); //this line sends the loan for approval request, which could take up to 24 hours
