...
//import com.doggywood.entities.EmployeeKeysBean;
...
@CrossOrigin(origins = "*")
@RestController
public class EmployeeKeysController {
...
// CUSTOMER BEAN LANDING 
	...
	public EmployeeKeysBean employeeWelcomBean() {
		return new EmployeeKeysBean("Welcome to Doggywood");
	}
//	 CUSTOMER BEAN LANDING - get info
//employee-welcome/value-variable/
	@GetMapping(value = "/employee-welcome/{email}")
	public EmployeeKeysBean employeeWelcomeBean(@PathVariable String email) {
		return new EmployeeKeysBean(String.format("Welcome to Doggywood, %s!", email));
	}
