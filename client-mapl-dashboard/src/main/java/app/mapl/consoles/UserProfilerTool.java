...
public class UserProfilerTool {
    ...
    public static void editProfile(UserDto user) {
        ...
        System.out.println(user + pw + ln + fn + userType + organizationCode + email + cusurl + dashboardCode + isActive + contactType);
        editLoop(user, pw, ln, fn, userType, organizationCode, email, cusurl, dashboardCode, isActive, contactType);
    }

    static void editLoop(UserDto user, String pw, String ln, String fn, int userType, String organizationCode, String email, String cusurl, String dashboardCode, int isActive, int contactType) {
        ...
        switch (Choice) {
            ...
            case 12:
                ...
                break;
            case 0:
                System.out.println("saveProfile" + user + pw + ln + fn + userType + organizationCode + email + cusurl + dashboardCode + isActive + contactType);
                saveProfile(user, pw, ln, fn, userType, organizationCode, email, cusurl, dashboardCode, isActive, contactType);
    ...
    static void saveProfile(UserDto user, String pw, String ln, String fn, int userType, String organizationCode, String email, String cusurl, String dashboardCode, int isActive, int contactType) {
