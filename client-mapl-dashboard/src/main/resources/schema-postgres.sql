...
(
    ...
    constraint fk_users_created_by foreign key (created_by) references USER_ENTITY (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
    constraint fk_users_updated_by foreign key (updated_by) references USER_ENTITY (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
    PRIMARY KEY (id)
);
...
(
    ...
    user_id BIGINT NOT NULL,
    CONSTRAINT fk_user_roles_user_id FOREIGN KEY (user_id) REFERENCES USER_ENTITY (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
...
(
    ...
    user_id BIGINT NOT NULL,
    CONSTRAINT fk_user_permissions_user_id FOREIGN KEY (user_id) REFERENCES USER_ENTITY (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
...
(
    id          BIGINT   PRIMARY KEY (id)     NOT NULL AUTO_INCREMENT,
    name        VARCHAR(255) NULL,
    authority   VARCHAR(255) NULL,
    reference_id VARCHAR(255) NULL,
    created_by  BIGINT       NOT NULL,
