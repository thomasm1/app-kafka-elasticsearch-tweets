...
public class FileVisitor {
    public static void main(String[] args) {
        ...
        java.nio.file.FileVisitor<Path> statsVisitor = new StatsVisitor(Integer.MAX_VALUE);
        try {
    ...
    private static class StatsVisitor implements java.nio.file.FileVisitor<Path> {
